...
class Bio_reactor_1:
    ...
    #    Sigma_w0 = [1.,150.**2,0.]*diag(np.ones(nd))*1e-3
        ...
        t     = SX.sym('t')
        Obj_M = 0.#Function('mayer', [xd, x_ref, u], [-q])  # Mayer term
        Obj_L = 0.#Function('lagrange', [xd, x_ref, u], [0.])  # Lagrange term
        Obj_D = 0.#Function('Discrete', [xd, x_ref, u], [0.])  # Lagrange term
    ...
    def integrator_model(self):
        ...
        """
        dt, x0, Lsolver, c_code, shrinking_horizon = self.specifications()
